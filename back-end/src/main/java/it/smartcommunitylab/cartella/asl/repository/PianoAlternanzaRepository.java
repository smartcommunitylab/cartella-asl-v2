...
public interface PianoAlternanzaRepository extends JpaRepository<PianoAlternanza, Long> {
	...
	@Modifying
	@Query("update PianoAlternanza pa0 set titolo=:#{#pa.titolo},oreTerzoAnno=:#{#pa.oreTerzoAnno},oreQuartoAnno=:#{#pa.oreQuartoAnno},oreQuintoAnno=:#{#pa.oreQuintoAnno},note=:#{#pa.note} where id = :#{#pa.id}")
