...
public class ReportDashboardDettaglioAttivita {
	private Long id;
	private String uuid;
	...
	public ReportDashboardDettaglioAttivita() {}
	
	public ReportDashboardDettaglioAttivita(AttivitaAlternanza attivita) {
